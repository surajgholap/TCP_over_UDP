...
LOGGER = testdata.logging.get_logger("hw5-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = testdata.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = testdata.utils.file_summary(RECV_PATH)
